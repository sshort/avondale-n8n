...
This document turns the project plan in [PLAN.md](/mnt/c/dev/avondale-n8n/PLAN.md) into an implementation design for batching newly parsed Gmail signups in n8n. The design covers the data model, workflow behavior, query structure, error handling, and validation strategy.
