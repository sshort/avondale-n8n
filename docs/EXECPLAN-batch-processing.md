...
- [x] (2026-03-11 10:22Z) Read the project plan in `/mnt/c/dev/avondale-n8n/docs/PLAN.md`, the design doc in `/mnt/c/dev/avondale-n8n/docs/DESIGN.md`, and the ExecPlan rules in `/mnt/c/dev/PLAN.md`.
...
- `/mnt/c/dev/avondale-n8n/docs/PLAN.md`: the original batch-processing goal.
- `/mnt/c/dev/avondale-n8n/docs/DESIGN.md`: the design that refines the plan into concrete database and workflow behavior.
