...
| **Browser Automation** | [http://192.168.1.237:3001/health](http://192.168.1.237:3001/health) | Playwright automation API for ClubSpark and Metabase jobs. |
| **AppSmith** | [http://192.168.1.237:8080](http://192.168.1.237:8080) | Internal admin application. |
| **Stirling PDF** | [http://192.168.1.204:8080](http://192.168.1.204:8080) | PDF post-processing service used for report sanitizing and redaction. |
...
---
Additional browser-automation endpoints:
